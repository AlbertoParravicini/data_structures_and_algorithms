...
The number of comparisons seems to have a parabolic concave shape, with a unique local maximum in $k = \frac{n}{2}$, consistent with the previous theoretical results.
Once again, the measured values are inline with the theoretical ones. In this case, the \textit{MAPE} is $0.79\%$.
